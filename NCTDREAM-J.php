...
<?php
    ...
    GROUP BY product.ItemID HAVING (product.ItemID) ='6'
    ";
  ...
  <section id="heroalbum">
    <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <!-- Slide 1 -->
        <div class="carousel-item active" style="background-image: url(img/dream1.jpg)">
          
        </div>

        <!-- Slide 2 -->
        <div class="carousel-item" style="background-image: url(img/dream2.jpg)">
          
        </div>

        <!-- Slide 3 -->
        <div class="carousel-item" style="background-image: url(img/dream3.jpg)">
    ...
    <br><br><br><br><br><br>
        <div class="row">
          <div class="col-md-12 form-group">
              <center><img src="img/dream4.jpg" width="700"></center>
          </div>
        </div>
