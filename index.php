...
<body>
	...
	<div class="popup-center">
		...
		<div class="popup-container">
			...
			<strong><div style="font-size:10px" align="right"><a href="Admin.php" style="color:#E8126A">ADMIN PAGE</a></div></strong>
			  <h2 class="popup-login">Log In</h2>
        	...
        	<?php endif ?>
			<div class="signup-link">New User? <a href="signup.php">Create an account</a></div>
